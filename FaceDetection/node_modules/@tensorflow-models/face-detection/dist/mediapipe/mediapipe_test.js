        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 3:
                    ...
                    test_util_1.expectNumbersClose(box.xMin, expectedBox.xMin, EPSILON_IMAGE);
                    test_util_1.expectNumbersClose(box.xMax, expectedBox.xMax, EPSILON_IMAGE);
                    test_util_1.expectNumbersClose(box.yMin, expectedBox.yMin, EPSILON_IMAGE);
                    test_util_1.expectNumbersClose(box.yMax, expectedBox.yMax, EPSILON_IMAGE);
                    test_util_1.expectNumbersClose(box.width, expectedBox.width, EPSILON_IMAGE);
                    test_util_1.expectNumbersClose(box.height, expectedBox.height, EPSILON_IMAGE);
...
jasmine_util_1.describeWithFlags('MediaPipe FaceDetector static image ', jasmine_util_1.BROWSER_ENVS, function () {
    var image;
    var timeout;
