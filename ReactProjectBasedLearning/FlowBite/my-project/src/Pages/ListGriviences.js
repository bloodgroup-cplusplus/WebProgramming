        ...
        {griviences.map((grivience)=>(
          <article className="p-6 bg-white rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700">
              <div className="flex justify-between items-center mb-5 text-gray-500">
                  ...
                  <span className="text-sm">{dayjs(grivience['createdAt'].toDate().toString().substring(3,25)).fromNow()}</span>
              </div>
              <h2 className="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">{grivience['headline']}</h2>
              ...
              <div className="flex justify-between items-center">
                  ...
                  {/*<a href="/comments"  className="inline-flex items-center font-medium text-primary-600 dark:text-primary-500 hover:underline">
                      Read more
