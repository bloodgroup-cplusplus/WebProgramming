...
<h2 className="text-center mb-4 text-4xl tracking-tight font-extrabold text-gray-900 dark:text-white">Contact Us</h2>
        ...
        <div className="flex flex-wrap pt-12 lg:pt-0">
          <div className="mb-12 grow-0 shrink-0 basis-auto w-full md:w-6/12 lg:w-full xl:w-6/12 px-3 md:px-6 xl:px-12">
            <div className="flex items-start">
              ...
              <div className="grow ml-6">
                ...
                <p className="text-gray-500 font-extralight"><a href="mailto:filer.gloves.0t@icloud.com">filer.gloves.0t@icloud.com</a></p>
              </div>
            </div>
          </div>
          <div className="mb-12 grow-0 shrink-0 basis-auto w-full md:w-6/12 lg:w-full xl:w-6/12 px-3 md:px-6 xl:px-12">
          ...
          <div className="mb-12 grow-0 shrink-0 basis-auto w-full md:w-6/12 lg:w-full xl:w-6/12 px-3 md:px-6 xl:px-12">
            <div className="flex align-start">
              ...
              <div className="grow ml-6">
                <p className="font-bold mb-1">Press Release</p>
                <p className="text-gray-500 font-extralight">press@example.com</p>
