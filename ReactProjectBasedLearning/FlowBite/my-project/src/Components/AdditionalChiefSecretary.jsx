...
const AdditionalChiefSecretary = () => {
  return (
    ...
    <h2 className="text-center mb-4 text-4xl tracking-tight font-extrabold text-gray-900 dark:text-white">Additional Chief Secretary's Message</h2>
    
      <div className="block rounded-lg shadow-lg bg-white">
        <div className="flex flex-wrap items-center">
          <div className="grow-0 shrink-0 basis-auto block lg:flex w-full lg:w-6/12 xl:w-4/12">
            <img src={additional_chief_secretary} alt="Trendy Pants and Shoes"
              className="w-full rounded-t-lg lg:rounded-tr-none lg:rounded-bl-lg" />
          </div>
          <div className="grow-0 shrink-0 basis-auto w-full lg:w-6/12 xl:w-8/12">
            <div className="px-6 py-12 md:px-12">
              <h2 className="text-3xl font-bold mb-2 text-black">  Shri Ravindra Telang(IAS)</h2>
              <p className="font-semibold mb-4">Additional Chief Secretary Sikkim</p>
