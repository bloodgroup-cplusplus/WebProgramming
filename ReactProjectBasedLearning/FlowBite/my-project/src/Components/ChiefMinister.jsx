...
<h2 className="text-center mb-4 text-4xl tracking-tight font-extrabold text-gray-900 dark:text-white">Chief Minister's Message</h2>
    ...
    <div className="flex flex-wrap items-center">
      ...
      <div className="grow-0 shrink-0 basis-auto w-full lg:w-6/12 xl:w-8/12">
        <div className="px-6 py-12 md:px-12">
          <h2 className="text-3xl font-bold mb-2 text-black">Shri Prem Singh Tamang (Golay)</h2>
          <p className="font-semibold mb-4">Chief Minister Sikkim</p>
