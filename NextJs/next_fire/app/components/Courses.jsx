...
const Courses = (props) => {
    const collegeName = props.college
  return (
      ...
      <div className="grid gap-8 lg:grid-cols-2">
          <article className="p-6 bg-white rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700">
              ...
              <div className="flex justify-between items-center">
                  ...
                  <Link href={{pathname:'/apply', query:{college:collegeName, course:"Economics"}}} className="inline-flex items-center font-medium text-green-500 dark:text-primary-500 hover:underline">
                      Apply
...
Join us for a rewarding journey in History and discover how the study of the past can help you understand the present and shape the future!</p>              <div className="flex justify-between items-center">
                  <div className="flex items-center space-x-4">
                      <Image className=" rounded-full" width={36} height={36} src={prof} alt="Bonnie Green avatar" />
                      <span className="text-xs font-medium dark:text-white">
                          Dr. Somedean Again (HOD)
                      </span>
                  </div>
                  <Link href={{pathname:"/apply", query:{college:collegeName,course:"History"}}} className="inline-flex items-center font-medium text-green-500 dark:text-primary-500 hover:underline">
                      Apply
                      <svg className="ml-2 w-4 h-4" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M10.293 3.293a1 1 0 011.414 0l6 6a1 1 0 010 1.414l-6 6a1 1 0 01-1.414-1.414L14.586 11H3a1 1 0 110-2h11.586l-4.293-4.293a1 1 0 010-1.414z" clip-rule="evenodd"></path></svg>
                  </Link>
              </div>
