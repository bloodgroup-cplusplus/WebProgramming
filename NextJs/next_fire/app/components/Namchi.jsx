...
const Namchi = () => {
    ...
    <Link href= {{pathname:'/courses', query:{college:'Namchi'}}}className="inline-flex items-center justify-center px-5 py-3 mr-3 text-base font-medium text-center text-white rounded-lg bg-green-500 hover:bg-primary-800 focus:ring-green-400 focus:ring-green-400 dark:focus:ring-primary-900">
                    View Courses
